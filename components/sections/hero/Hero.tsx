        ...
        <div className={styles.inner}>
          <div className={styles.copy}>
            ...
            <div className={styles.actionsSecondary}>
              <a href={whatsappHref} target="_blank" rel="noreferrer" className={styles.secondary}>
                <svg className={styles.buttonIcon} aria-hidden="true" viewBox="0 0 24 24" fill="none">
              ...
              <a href={instagramUrl} target="_blank" rel="noreferrer" className={styles.secondary}>
                <svg className={styles.buttonIcon} aria-hidden="true" viewBox="0 0 24 24" fill="none">
