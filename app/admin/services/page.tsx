  ...
  return (
    <AdminShell>
      <section className={styles.panel}>
        ...
        <div className={styles.servicesWorkspace}>
          <div className={`${styles.card} ${styles.servicesCreateCard}`}>
            <h2 className={styles.cardTitle}>Vytvořit službu</h2>
            <form action={actions.createServiceAction} className={`${styles.form} ${styles.servicesCompactForm}`}>
              <div className={styles.servicesInlineFields}>
                ...
                <div className={`${styles.formGroup} ${styles.servicesWideField}`}>
          ...
          <div className={styles.servicesEditorGrid}>
            {services.map((service) => (
              <div key={service.id} className={`${styles.card} ${styles.servicesItemCard}`}>
                <h2 className={styles.cardTitle}>{service.title}</h2>
                <div className={styles.cardMeta}>Pořadí: {service.order}</div>
                <form id={`update-service-${service.id}`} action={actions.updateServiceAction} className={`${styles.form} ${styles.servicesCompactForm}`}>
